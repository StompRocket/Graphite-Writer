var app = new Vue({
  ...
  data: {
    footer: 'Graphite Writer is a passion project by Ronan.F with help from Sasha.S. If you have any questions or suggestions, please contact us at <a href="mailto:support@graphitewriter.com">support@graphitewriter.com</a><br>' +
      ...
      'Graphite Writer is proudly sponsered by the folowing: <b> Ronan, Rohan.P </b> <br>' +
      'Would you like yor name up here? please contact us at <a href="mailto:support@graphitewriter.com">support@graphitewriter.com</a> <br> <br>' +
      'By using Graphite Writer you agree to be bound by our <a href="/termsofservice">terms of service</a>'
  }
})
